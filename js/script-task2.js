...
/*6.50. Дано натуральное число.
в) Верно ли, что цифра a встречается в нем более k раз?
г) Определить, есть ли в нем цифры a и b. */
{
    digitaln = parseInt(prompt("Введите натуральное число"));
    a = parseInt(prompt("Введите число a, которое может встретиться"))
    b = parseInt(prompt("Введите число b, которое может встретиться"))
    k = parseInt(prompt("введите сколько раз число a может встретиться в Натуральном числе"))
